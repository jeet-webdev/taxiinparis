  ...
  return (
    <div className="px-1 text-left flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 mb-5">
        <div className="w-12 h-12 rounded-full border-2 border-[#a8a85a]/60 flex items-center justify-center">
          {icon}
        </div>

        <h3 className="text-[22px] text-[#a8a85a] tracking-wide">
          {title}
        </h3>
      </div>
      ...
      {isLongContent && (
        <button
          ...
          className="mt-3 text-[#a8a85a] text-sm font-medium hover:underline self-start"
        >
