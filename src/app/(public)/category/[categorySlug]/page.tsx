...
//                 <Image
//                   src={
//                     page.imageUpload || "/assets/images/luxury-limo-chiah3.webp"
//                   }
  ...
  try {
    ...
    if (typeof content === "string") {
      try {
        ...
        html = parsed.content || content;
      } catch {
        html = content;
      }
    } else if (typeof content === "object" && content !== null) {
      const casted = content as { content?: string };
      html = casted.content || "";
    }
  ...
  return (
    <main className="min-h-screen bg-white pb-20">
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {category.categoryPages.map((page) => {
            // 1. Use imageUpload if set, otherwise extract from content
            const cardImage =
              page.imageUpload ||
              extractFirstImage(page.content) ||
              "/assets/images/luxury-limo-chiah3.webp";
