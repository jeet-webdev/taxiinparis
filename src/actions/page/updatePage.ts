...
const updatePageSchema = z.object({
  ...
  secureBookingIcon: z.string().optional().nullable(),
  reliableServiceIcon: z.string().optional().nullable(),
  customerServiceIcon: z.string().optional().nullable(),
  fairPriceIcon: z.string().optional().nullable(),
